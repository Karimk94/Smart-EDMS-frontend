...
const systems: SystemCard[] = [
    {
        id: 'smart-edms',
        title: 'Smart EDMS',
        description: 'Electronic Document Management System with AI-powered analysis for organizing, searching, and managing your digital documents efficiently.',
        icon: (
    ...
    },
    {
        id: 'pta-edms',
        title: 'PTAEDMS',
        description: 'PTA Electronic Document Management System for handling PTA-specific documentation and workflow management.',
        icon: (
            <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <>
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex flex-col">
                ...
                <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full">
                    <div className="mb-10">
                        <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">
                            Welcome to EDMS Portal
                        </h2>
                        <p className="text-slate-600 dark:text-slate-400">
                            Select a system below to access your document management tools
                        </p>
                    </div>
                ...
                <footer className="py-6 text-center text-slate-500 dark:text-slate-400 text-sm border-t border-slate-200 dark:border-slate-700">
                    <p>&copy; {new Date().getFullYear()} EDMS Portal. All rights reserved.</p>
                </footer>
            </div>
        </>
    );
